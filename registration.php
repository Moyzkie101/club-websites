			...
			<div class="account-form">
				...
				<div class="account-form-inner">
					<div class="account-container">
						...
						<form class="contact-bx" method="POST" action="registration.php">
							<div class="row placeani">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="input-group">
											<label>Email</label>
											<input class="form-control" type="email" name="email" required maxlength="150">
										</div>
									</div>
								</div>
								<div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="input-group">
											...
											<input class="form-control" id="password" type="password" name="password" required maxlength="150">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="input-group">
											...
											<input class="form-control" id="password1" type="password" name="confirm-password" required maxlength="150">
											<span toggle="#password1" class="fa fa-fw fa-eye field-icon toggle-password"></span>
										</div>
									</div>
								</div>
								<div class="col-lg-12 m-b30" align="center">
									<button  type="submit" name="register" class="red-hover btn button-md" style="background-color: #5691cf!important;">Register Account</button>
								</div>
								<div class="col-lg-12 m-b30">Already have an account? <a href="login_access.php">Login here</a></div>
								</div>
							</div>
						</form>
					</div>
...
<?php
   ...
   if (isset($_POST["register"])) {
		...
		if($_POST["password"] === $_POST["confirm-password"]){
	        ...
	        $query = mysqli_query($conn,"select * from tblresident where national_id='".$_POST["national_id"]."'");

	        $query2 = mysqli_query($conn,"select * from tblresident where email='".$_POST["email"]."'");

	        if (mysqli_affected_rows($conn) > 0) {

	              $resident = mysqli_fetch_array($query);

	              $resident2 = mysqli_fetch_array($query2);

	              mysqli_query($conn,"insert into tbl_users values(NULL,'".$_POST['username']."','".sha1($_POST['password'])."','".$resident2['email']."','resident','','','".date('m-d-Y h:i a')."',".$resident['id'].")");
