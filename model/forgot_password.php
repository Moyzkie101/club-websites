...
<head>
        ...
        <title>Barangay Bolocboloc | FORGOT PASSWORD</title>
            ...
            <div class="account-form">
                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        ...
                        <form class="contact-bx" method="POST" action="forgot_password.php">
                            <div class="row placeani">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group"> 
                                            <label>Enter Email Account</label>
                                            <input id="email" name="email" type="email" class="form-control" minlength="5" maxlength="150" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group form-forget">
                                        <span>Back to <a href="login_access.php">Login</a>.</span>
                                    </div>
                                </div>
                                <div class="col-lg-6 m-b30" align="right">
                                        <button name="submit" type="submit" class="red-hover btn button-md" style="background-color: #5691cf!important;" value="submit">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php
   ...
   if (isset($_POST["submit"])) {
        ...
        $query1 = mysqli_query($conn,"select * from tblresident where email='".$_POST["email"]."'");

        if (mysqli_affected_rows($conn) > 0) {

            $resident1 = mysqli_fetch_array($query1);

            if (mysqli_affected_rows($conn) > 0) {

                mysqli_query($conn,"UPDATE tbl_users SET code='".$code."' WHERE email='".$resident1['email']."'");
                ...
                try{
                    ...
                    //Recipients
                    $mail->setFrom('brgybolocboloc.infosys@gmail.com', 'LGU Brgy. Bolocboloc');
                    $mail->addAddress($_POST['email']);

                    //Content
                    $mail->isHTML(true);                                  //Set email format to HTML
                    $mail->Subject = 'User\'s Verification Link.';
                    $mail->Body    = 'Here is the Verification Link <b><a href="https://brgybolocboloc.000webhostapp.com/change_password.php?reset='.$code.'&email='.$_POST['email'].'">https://brgybolocboloc.000webhostapp.com/change_password.php?reset='.$code.'&email='.$_POST['email'].'</a></b>';
                ...
                ?>
                    <script> 
                        ...
                        window.location.href = "login_access.php";
                    </script>
                <?php
                }
        } else {
