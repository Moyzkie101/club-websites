    ...
    if(!empty($user) && !empty($pass) && !empty($usertype)){
        ...
        if($res->num_rows){
            ...
            if(!empty($profile) && !empty($profile2)){
                $insert  = "INSERT INTO tbl_users (`username`, `password`, `email`, `user_type`, `avatar`) VALUES ('$user', '$pass', '$email', '$usertype', '$profile')";
                ...
                $insert  = "INSERT INTO tbl_users (`username`, `password`, `email`, `user_type`, `avatar`) VALUES ('$user', '$pass', '$email', '$usertype','$newName')";
                $result  = $conn->query($insert);
                ...
                $insert  = "INSERT INTO tbl_users (`username`, `password`, `email`, `user_type`, `created_at`)
                            VALUES ('$user', '$pass', '$email', '$usertype', '$datetime')";
                $result  = $conn->query($insert);
