...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="assets/images/logo2.png" />
		<title>Barangay Bolocboloc | ORGANIZATIONAL STRUCTURE</title>
        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/cover1.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Barangay Bolocboloc Brgy. Officials</h1>
				 </div>
            </div>
        </div>
						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							<div class="profile-bx text-center">
								<div class="user-thumb">
									<img src="assets/images/org-structure/Captain1.png" style="width: 250px; height: 280px;">	
								</div>
								<div class="profile-info">
									<h4> AQUILES O. CAÑETE</h4>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="courses">
										<div class="profile-head">
											<h3><span style="color: #5691cf">Barangay</span> Profile</h3>
											<div class="feature-filters style1 ml-auto">
												<ul class="filters" data-toggle="buttons">
													...
													<li data-filter="5" class="btn">
														<input type="radio">
														<a href="#"><span>Brgy. Counsilor</span></a> 
													</li>
													...
													<li data-filter="15" class="btn">
														<input type="radio">
														<a href="#"><span>Brgy. Secretary</span></a> 
													</li>
													<li data-filter="20" class="btn">
														<input type="radio">
														<a href="#"><span>Brgy. Treasurer</span></a> 
													</li>
													<li data-filter="25" class="btn">
														<input type="radio">
														<a href="#"><span>Chief Tanod</span></a> 
													</li>
												</ul>
											</div>
										</div>
											...
											<div class="clearfix">
												<ul id="masonry" class="ttr-gallery-listing magnific-image row">
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 10">
														<div class="cours-bx">
															<div class="action-box">
																<img src="assets/images/org-structure/BRANZUELA.png" style="width: 250px; height: 260px;">	
															</div>
															<div class="info-bx text-center">
																<h5><a href="#">JANRAY C. BRANZUELA</a></h5>
																<span><b>SK Chairman</b></span><br>
															</div>
														</div>
													</li>
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 5">
														<div class="cours-bx">
															<div class="action-box">
																 <img src="assets/images/org-structure/Apolinar.png" style="width: 250px; height: 260px;"> 	
															</div>
															<div class="info-bx text-center">
																 <h5><a href="#">APOLINAR A. TRAYA</a></h5>
																<span><b>Barangay Counsilor</b></span><br> 
															</div>
														</div>
													</li>
														...
														<div class="cours-bx">
															<div class="action-box">
																 <img src="assets/images/org-structure/Trinidad.png" style="width: 250px; height: 260px;"> 	
															</div>
															<div class="info-bx text-center">
																 <h6><a href="#">FRANSICO RIVERO P. TRINIDAD</a></h6>
																<span><b>Chief Tanod</b></span><br> 
															</div>
														</div>
													</li>
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 5">
														<div class="cours-bx">
															<div class="action-box">
																 <img src="assets/images/org-structure/Etic.png" style="width: 250px; height: 260px;"> 	
															</div>
															<div class="info-bx text-center">
																 <h5><a href="#">ANALEE B. ETIC</a></h5>
																<span><b>Barangay Counsilor</b></span><br> 
															</div>
														</div>
														...
														<div class="cours-bx">
															<div class="action-box">
																 <img src="assets/images/org-structure/Pateres.png" style="width: 250px; height: 260px;"> 	
															</div>
															<div class="info-bx text-center">
																 <h6><a href="#">EDUARDO T. PATERES JR.</a></h6>
																<span><b>Barangay Counsilor</b></span><br> 
															</div>
														</div>
													</li><li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 5">
														<div class="cours-bx">
															<div class="action-box">
																 <img src="assets/images/org-structure/Panugan.png" style="width: 250px; height: 260px;"> 	
															</div>
															<div class="info-bx text-center">
																 <h5><a href="#">DIONISIO S. PANUGAN</a></h5>
																<span><b>Barangay Counsilor</b></span><br> 
															</div>
														</div>
													</li><li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 5">
														<div class="cours-bx">
															<div class="action-box">
																 <img src="assets/images/org-structure/Tigley.png" style="width: 250px; height: 260px;"> 	
															</div>
															<div class="info-bx text-center">
																 <h5><a href="#">ANTONIETO E. TIGLEY</a></h5>
																<span><b>Barangay Counsilor</b></span><br> 
															</div>
														</div>	
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 15">
														<div class="cours-bx">
															<div class="action-box">
																<img src="assets/images/org-structure/Alquizola.png" style="width: 250px; height: 260px;">	
															</div>
															<div class="info-bx text-center">
																<h5><a href="#">VERONICO G. ALQUIZOLA</a></h5>
																<span><b>Barangay Secretary</b></span><br>
															</div>
														</div>
													</li>
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 5">
														<div class="cours-bx">
															<div class="action-box">
																<img src="assets/images/org-structure/Alcoseba.png" style="width: 250px; height: 260px;">	
															</div>
															<div class="info-bx text-center">
																<h6><a href="#">ABIEL ANGELITO ALCOSEBA</a></h6>
																<span><b>Barangay Counsilor</b></span><br>
															</div>
														</div>
													</li>
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 5">
														<div class="cours-bx">
															<div class="action-box">
																<img src="assets/images/org-structure/Alesna.png" style="width: 250px; height: 260px;">	
															</div>
															<div class="info-bx text-center">
																<h5><a href="#">JEJOMAR A. ALESNA</a></h5>
																<span><b>Barangay Counsilor</b></span><br>
															</div>
														</div>
													</li>
													<li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 20">
														<div class="cours-bx">
															<div class="action-box">
																<img src="assets/images/org-structure/Bitanga.png" style="width: 250px; height: 260px;">	
															</div>
															<div class="info-bx text-center">
																<h5><a href="#">PATERNA M. BITANGA</a></h5>
																<span><b>Barangay Treasurer</b></span><br>
															</div>
														</div>
													</li>
												</ul>
