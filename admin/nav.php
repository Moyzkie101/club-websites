...
<ul id="main-menu">
	...
	<li class="" id="hassubopen">
		<a href="#" onclick="memberExpand(1)"><i class="entypo-users"></i><span>Members</span></a>
		<ul id="memExpand">
	...
	<li class="" id="planhassubopen">
		<a href="#" onclick="memberExpand(2)"><i class="entypo-quote"></i><span>Sports Plan</span></a>
		<ul id="planExpand">
			<li class="active"><a href="new_plan.php"><span>New Sports Plan</span></a></li>
			<li><a href="view_plan.php"><span>Edit Subscription Details</span></a></li>
		</ul>
	</li>
	<li class="" id="overviewhassubopen">
		<a href="#" onclick="memberExpand(3)"><i class="entypo-box"></i><span>Overview</span></a>
