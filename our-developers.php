...
<head>
	...
	<title>Barangay Bolocboloc | OUR DEVELOPERS</title>
        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/cover1.jpg);">
            <!-- <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Barangay Bolocboloc Developers</h1>
				 </div>
            </div> -->
        </div>
                ...
                <div class="container">
					<div class="row gx-5">
						<div class="col-lg-6 col-md-5 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-developer/ourdeveloper-cover2.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<h3>Grace C. Caballero</h3>
									<h4>Project Leader, System Analyst and Documentor</h4><br><br><br>
									<div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://www.facebook.com/5Caballero0108" target="blank">
										...
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&su=New+Stranger+from:&to=gracecaballero123@gmail.com" target="blank">
						...
						<div class="col-lg-6 col-md-5 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-developer/ourdeveloper-cover3.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<h3>Chericel A. Bornea</h3>
									<h4>Back-End Programmer and Tester / Debugger</h4><br><br><br>
									<div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://www.facebook.com/chericel.bornea" target="blank">
													<i class="fa fa-facebook text-primary"></i>
												</a>
											</div><br><br><br>
										</div>
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&su=New+Stranger+from:&to=checkziebornea@gmail.com" target="blank">
													<i class="fa fa-envelope text-primary"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-lg-6 col-md-5 col-sm-6">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/our-developer/ourdeveloper-cover1.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<h3>Cristo Ray M. Corales</h3>
									<h4>Front-End Programmer, Back-End Programmer and Tester / Debugger</h4><br><br><br>
									<div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://www.facebook.com/CristoRay98" target="blank">
													<i class="fa fa-facebook text-primary"></i>
												</a>
											</div><br><br><br>
										</div>
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&su=New+Stranger+from:&to=cristoray.corales29@gmail.com" target="blank">
													<i class="fa fa-envelope text-primary"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-lg-6 col-md-5 col-sm-6">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/our-developer/ourdeveloper-cover4.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<h3>Clark G. Aliño</h3>
									<h4>Front-End Programmer and Tester / Debugger</h4><br><br><br>
									<div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://www.facebook.com/clark.alino.5" target="blank">
													<i class="fa fa-facebook text-primary"></i>
												</a>
											</div><br><br><br>
										</div>
										<div class="col-lg-6 col-md-5 col-sm-5">
											<div class="feature-box-sm radius bg-white">
												<a href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&su=New+Stranger+from:&to=gonzagaalinoclark@gmail.com" target="blank">
													<i class="fa fa-envelope text-primary"></i>
												</a>
											</div>
										</div>
