...
<head>
       ...
       #boxx
	{
      ...
      <body class="page-body  page-fade" onload="collapseSidebar()">
        ...
        <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php"> <!-- diri ko dapita start pero tarongonon -->
       ...
       </form> <!-- diri ko dapita end pero tarongonon -->
    </div>
    </div>   
